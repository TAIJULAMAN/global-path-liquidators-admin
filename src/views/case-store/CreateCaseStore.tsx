...
const CreateCaseStore = () => {
  ...
  const [dealName, setSelectedDealName] = useState("case_store");
  ...
  return (
    <div className="">
      <div>
        <div className="text-2xl text-natural-900 font-bold my-5">
          Add New Case Store Products
        </div>
        ...
        <form className="border rounded p-5 dark:border-gray-600">
          ...
          <div className="mt-4">
            <h2 className="text-center mb-2 font-semibold mt-10">
              Your Images
            </h2>
            <div
              className="border-dashed border-2 border-gray-300 p-8 text-center "
        ...
        {dealName === "bin_store" && (
          <div className="mt-2">
            <form className="border rounded p-5 dark:border-gray-600">
              <div className="mt-2 text-2xl text-natural-900 font-semibold my-3">
                Bin Store Product
              </div>
              <div className=" grid grid-cols-1 md:grid-cols-2 gap-2">
                <div>
...
export default CreateCaseStore;
